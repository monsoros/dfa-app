...
function DFA() {
    ...
    const updateChange = (shareValue) => {
        ...
        if (mode.current === 0) {
            ...
            if (shareValue.length > 1 && shareValue[shareValue.length - 2] === password[0] && shareValue[shareValue.length - 1] === password[1]) {
            ...
            if (shareValue.length > 2 && shareValue[shareValue.length - 3] === password[0] && shareValue[shareValue.length - 2] === password[1] && shareValue[shareValue.length - 1] === password[2]) {
